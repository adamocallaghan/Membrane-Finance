...
contract SetPeers is Script {
    function run() external {
        ...
        bytes32 OPTIMISM_SEPOLIA_OAPP_BYTES32 = 0x00000000000000000000000076bAeaE38288Df2504775F8e5B0084C0E1012A21;

        uint256 baseLzEndIdUint = vm.envUint("BASE_SEPOLIA_LZ_ENDPOINT_ID");
        uint32 BASE_SEPOLIA_LZ_ENDPOINT_ID = uint32(baseLzEndIdUint);
        bytes32 BASE_SEPOLIA_OAPP_BYTES32 = 0x00000000000000000000000076bAeaE38288Df2504775F8e5B0084C0E1012A21;
