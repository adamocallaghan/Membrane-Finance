...
contract SetPeers is Script {
    function run() external {
        ...
        bytes32 OPTIMISM_SEPOLIA_OAPP_BYTES32 = 0x00000000000000000000000007040be54DDbD74B0f4cf4A40A4B3ef4Ca5217FE;

        uint256 baseLzEndIdUint = vm.envUint("BASE_SEPOLIA_LZ_ENDPOINT_ID");
        uint32 BASE_SEPOLIA_LZ_ENDPOINT_ID = uint32(baseLzEndIdUint);
        bytes32 BASE_SEPOLIA_OAPP_BYTES32 = 0x0000000000000000000000009Ccd0A438E7938e3539d83C0E29326353F50338d;
