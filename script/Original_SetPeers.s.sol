...
contract SetPeers is Script {
    function run() external {
        ...
        bytes32 OPTIMISM_SEPOLIA_OAPP_BYTES32 = 0x00000000000000000000000075057e6fBf35dFA697809Fb34b5f3Dfc8C1D6745;

        uint256 baseLzEndIdUint = vm.envUint("BASE_SEPOLIA_LZ_ENDPOINT_ID");
        uint32 BASE_SEPOLIA_LZ_ENDPOINT_ID = uint32(baseLzEndIdUint);
        bytes32 BASE_SEPOLIA_OAPP_BYTES32 = 0x00000000000000000000000075057e6fBf35dFA697809Fb34b5f3Dfc8C1D6745;
